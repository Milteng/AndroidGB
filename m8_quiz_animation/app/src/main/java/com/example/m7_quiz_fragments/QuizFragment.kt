...
class QuizFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        alphaRG(binding.question1)
        alphaRG(binding.question2)
        alphaRG(binding.question3)


        binding.button.setOnClickListener {
            val number = getCorrectAnswersByUser()
            var bundle = bundleOf(ARG_PARAM_NUM to number)
    ...
    fun alphaRG(radioGroup: RadioGroup){
        radioGroup.alpha = 0.1f;
