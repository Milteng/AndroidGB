...
class WelcomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
       ...
       //анимация через xml
        ...
        binding.btnInputBd.animate().apply {
            duration = 2000
            rotation(360f)
        ...
        binding.btnInputBd.setOnClickListener {
            ...
            dateDialog.addOnPositiveButtonClickListener { time ->
                ...
                val dateBith = dateFormat.format(calendar.time);

                /*val day = calendar.get(Calendar.DAY_OF_MONTH)
                val month = calendar.get(Calendar.MONTH)
                val year = calendar.get(Calendar.YEAR)
                val text = "$day/$month/$year"*/
                Snackbar.make(binding.btnInputBd, dateBith, Snackbar.LENGTH_SHORT).show()
            }
